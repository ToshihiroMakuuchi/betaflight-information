...
* 【双方向DSHOT】は[BetaFlight Performance Edition F3](https://github.com/joelucid/betaflight/releases)を利用する際は、是非お奨めの設定となります。BLHeli_M(JazzMarverick)、もしくはJESC ESCファームウェアを別途インストールしてください。
