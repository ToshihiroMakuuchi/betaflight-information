...
### Rateprofile設定
   ...
   ※ スロットルMID、スロットルEXPOはモーターのKV値や大きさにより可変させた方が良い場合があります。スロットルスティック中央で目線上でホバリングができるよう調整するような手法により複数機体の運用においてモーターの違いによる操作のバラつきを平準化させることも可能です。縦軸がスロットル開度(%)、横軸が出力となります。
